...
Provides functions and necessary 'JavaScript' bindings to quickly
transfer spatial data from R memory or remote URLs to the browser for
...
- Report bugs at <https://github.com/r-spatial/geoarrowWidget/issues>
