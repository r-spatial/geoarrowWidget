...
![](reference/figures/browser_console.png)*Note: the 200MB
`encodedBodySize` and 375ms `duration` in the screenshot are the result
of running the above code with `1e7` points.*
...
![](reference/figures/browser_source.png)
...
[![](https://r-consortium.org/images/RConsortium_Horizontal_Pantone.webp)](https://r-consortium.org/all-projects/funded-projects.html)
